...
import pulumi.codegen.diagnostic_pb2
...
class GenerateProgramResponse(google.protobuf.message.Message):
    ...
    SOURCE_FIELD_NUMBER: builtins.int
    @property
    def diagnostics(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[pulumi.codegen.diagnostic_pb2.Diagnostic]:
    ...
    def __init__(
        self,
        *,
        diagnostics: collections.abc.Iterable[pulumi.codegen.diagnostic_pb2.Diagnostic] | None = ...,
